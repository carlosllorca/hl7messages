 ...
 * @property string $physician_name1
 * @property string $physician_name2
 * @property string $id
 * @property string $physician_npi
 * @property string $orderNumber
 * @property string $universal_type_id
 * @property string $prefix_order
